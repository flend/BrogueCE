...
const blueprint blueprintCatalog_BulletBrogue[] = {
    ...
    {{2, 3},           {0, 0},     20,     4,          0,                  (BP_REWARD | BP_NO_INTERIOR_FLAG),  {
    ...
    {{1, DEEPEST_LEVEL-1}, {30, 80},   12,     5,          0,                  (BP_ROOM | BP_REWARD),  {
    ...
    {{1, DEEPEST_LEVEL-1}, {30, 80},   12,     4,          0,                  (BP_ROOM | BP_REWARD),  {
    ...
    {{3, DEEPEST_LEVEL-1},{50, 80},   5,      4,          0,                  (BP_ROOM | BP_REWARD | BP_SURROUND_WITH_WALLS | BP_PURGE_INTERIOR), {
    ...
    {{2, DEEPEST_LEVEL-1},{35, 40},   0,      4,          0,                  (BP_PURGE_INTERIOR | BP_OPEN_INTERIOR), {
    ...
    // Plain secret door
    {{1, DEEPEST_LEVEL-1}, {1, 1},     1,      1,          0,                  (BP_VESTIBULE), {
    ...
    {{1, DEEPEST_LEVEL-1}, {1, 1},     8,      3,          0,                  (BP_VESTIBULE), {
    ...
    {{1, DEEPEST_LEVEL-1}, {1, 1},     6,      2,          0,                  (BP_VESTIBULE), {
    ...
    {{2, DEEPEST_LEVEL-1}, {2, 2},     6,      2,          0,                  (BP_VESTIBULE), {
    ...
    {{1, DEEPEST_LEVEL-1}, {30, 60},   8,      3,          0,                  (BP_VESTIBULE | BP_OPEN_INTERIOR | BP_NO_INTERIOR_FLAG),    {
    ...
    {{2, DEEPEST_LEVEL-1}, {15, 30},   8,      3,          0,                  (BP_VESTIBULE | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR), {
    ...
    {{2, DEEPEST_LEVEL-1}, {25, 25},   8,      4,          0,                  (BP_VESTIBULE | BP_OPEN_INTERIOR),  {
    ...
    {{1, DEEPEST_LEVEL-1}, {15, 100},  1,      2,          0,                  (BP_ROOM | BP_ADOPT_ITEM), {
    ...
    {{1,1},             {30, 70},   7,      3,          0,                  (BP_ADOPT_ITEM | BP_ROOM),  {
    ...
    {{1, 2},           {80, 100},  10,     6,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR), {
    ...
    {{1, DEEPEST_LEVEL-1}, {80, 180},  10,     4,          0,                  (BP_ROOM | BP_SURROUND_WITH_WALLS | BP_PURGE_LIQUIDS | BP_PURGE_PATHING_BLOCKERS | BP_ADOPT_ITEM),  {
    ...
    {{2, DEEPEST_LEVEL-1}, {80, 180},  6,      5,          0,                  (BP_ROOM | BP_SURROUND_WITH_WALLS | BP_PURGE_LIQUIDS | BP_PURGE_PATHING_BLOCKERS | BP_ADOPT_ITEM),  {
    ...
    {{1, DEEPEST_LEVEL-1}, {15, 20},   10,     2,          0,                  (BP_ADOPT_ITEM),    {
    ...
    {{1, DEEPEST_LEVEL-1}, {45, 65},   13,     3,          0,                  (BP_ADOPT_ITEM | BP_TREAT_AS_BLOCKING), {
    ...
    {{1, DEEPEST_LEVEL-1}, {30, 100},  10,     3,          0,                  (BP_ROOM | BP_ADOPT_ITEM),  {
    ...
    {{1, 1},           {75, 120},  10,     9,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR | BP_SURROUND_WITH_WALLS),  {
    ...
    {{2, DEEPEST_LEVEL-1}, {55, 90},   10,     7,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR | BP_SURROUND_WITH_WALLS),  {
    ...
    {{2, DEEPEST_LEVEL-1},           {75, 120},  7,      7,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR),  {
    ...
    {{2, DEEPEST_LEVEL-1},           {40, 60},   3,      5,          0,                  (BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR | BP_TREAT_AS_BLOCKING),  {
    ...
    {{2, DEEPEST_LEVEL-1}, {35, 60},   7,      7,          0,                  (BP_ROOM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_ADOPT_ITEM), {
    ...
    {{3, DEEPEST_LEVEL-1}, {80, 90},   10,     5,          0,                  (BP_ROOM | BP_PURGE_LIQUIDS | BP_SURROUND_WITH_WALLS | BP_ADOPT_ITEM),  {
    ...
    // Statuary -- key on an altar, area full of statues; take key to cause statues to burst and reveal monsters
    {{2, DEEPEST_LEVEL-1},{35, 90},   10,     2,          0,                  (BP_ADOPT_ITEM | BP_NO_INTERIOR_FLAG),  {
    ...
    {{2, DEEPEST_LEVEL-1}, {35, 70},   8,      4,          0,                  (BP_ROOM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_ADOPT_ITEM), {
    ...
    {{2, DEEPEST_LEVEL-1}, {50, 95},   10,     6,          0,                  (BP_ROOM | BP_ADOPT_ITEM),  {
    ...
    {{2, DEEPEST_LEVEL-1}, {85, 100},   5,     7,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR | BP_SURROUND_WITH_WALLS),        {
    ...
    {{2, DEEPEST_LEVEL-1}, {20, 60},   12,     6,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_OPEN_INTERIOR | BP_SURROUND_WITH_WALLS),        {
    ...
    {{2, DEEPEST_LEVEL-1}, {60, 100},  10,     4,          0,                  (BP_ROOM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR | BP_ADOPT_ITEM), {
    ...
    {{2,DEEPEST_LEVEL-1}, {7, 7},     7,      2,          0,                  (BP_ADOPT_ITEM),    {
        {0,         ALTAR_SWITCH,DUNGEON,       {1,1},      1,          0,          -1,         0,              2,              0,          0,          (MF_ADOPT_ITEM | MF_NEAR_ORIGIN | MF_TREAT_AS_BLOCKING | MF_NOT_IN_HALLWAY)},
    ...
    {{2, DEEPEST_LEVEL-1},{40, 60},    10,     5,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_SURROUND_WITH_WALLS | BP_OPEN_INTERIOR | BP_PURGE_INTERIOR),  {
        {0,         CARPET,     DUNGEON,        {0,0},      0,          0,          -1,         0,              0,              0,          0,          (MF_EVERYWHERE)},
    ...
    {{2, DEEPEST_LEVEL-1},{60, 90},   10,     8,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_SURROUND_WITH_WALLS | BP_PURGE_INTERIOR), {
    ...
    {{3, DEEPEST_LEVEL-1},{45, 150},  10,     4,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_SURROUND_WITH_WALLS), {
        {0,         ALTAR_SWITCH,DUNGEON,       {1,1},      1,          0,          -1,         0,              2,              0,          0,          (MF_ADOPT_ITEM | MF_FAR_FROM_ORIGIN | MF_TREAT_AS_BLOCKING)},
    ...
    {{2, DEEPEST_LEVEL-1},{80, 175},   10,     6,          0,                  (BP_ROOM | BP_ADOPT_ITEM | BP_PURGE_INTERIOR | BP_MAXIMIZE_INTERIOR | BP_SURROUND_WITH_WALLS),  {
        {0,         ALTAR_INERT,DUNGEON,        {1,1},      1,          0,          -1,         0,              2,              0,          0,          (MF_ADOPT_ITEM | MF_FAR_FROM_ORIGIN | MF_TREAT_AS_BLOCKING)},
...
/*  else if (rogue.depthLevel < 3 && rogue.bonusWeaponsSpawned < rogue.depthLevel) {
            ...
            //Need an in-engine way to do this for BB*/
...
#define BULLET_BROGUE_VERSION_STRING "RB " STRINGIFY(BULLET_BROGUE_MAJOR) "." STRINGIFY(BULLET_BROGUE_MINOR) "." STRINGIFY(BULLET_BROGUE_PATCH) BROGUE_EXTRA_VERSION

// Recording version. Saved into recordings and save files made by this version.
// Cannot be longer than 16 chars
#define BULLET_BROGUE_RECORDING_VERSION_STRING "RB " STRINGIFY(BULLET_BROGUE_MAJOR) "." STRINGIFY(BULLET_BROGUE_MINOR) "." STRINGIFY(BULLET_BROGUE_PATCH)
